        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2.5 group">
              <motion.div
                className="w-8 h-8 rounded-lg flex items-center justify-center relative overflow-hidden border"
              ...
              <span className="font-extrabold text-[16px] tracking-tight text-white">
                Hackathon<span className="text-zinc-500">Hub</span>
              </span>
            </Link>
            ...
            <div className="hidden md:flex items-center gap-3">
              {session ? (
                <div className="relative" ref={dropdownRef}>
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="absolute -bottom-0.5 -right-0.5 w-2 h-2 bg-emerald-400 rounded-full border-2 border-black" />
                    </div>
                    <span className="text-sm font-medium text-zinc-200 max-w-[90px] truncate">
                  ...
                  <AnimatePresence>
                    {dropdownOpen && (
                      <motion.div
                        ...
                        className="absolute right-0 top-full mt-2 w-52 rounded-2xl overflow-hidden shadow-[0_24px_64px_rgba(0,0,0,0.8)]"
                ...
                <motion.button
                  ...
                  className="btn-white flex items-center gap-2 text-black text-sm font-semibold px-5 py-2.5 rounded-full"
            ...
            <motion.button
              ...
              className="md:hidden w-9 h-9 flex items-center justify-center rounded-xl text-zinc-400 hover:text-white transition-all"
        ...
        <AnimatePresence>
          {mobileOpen && (
            <motion.div
              ...
              style={{ borderTop: '1px solid rgba(255,255,255,0.06)', background: 'rgba(0,0,0,0.95)' }}
            >
                ...
                >
                  {session ? (
                    ...
                    <button onClick={() => signIn('google')}
                      className="btn-white flex items-center justify-center gap-2 w-full text-black text-sm font-semibold px-4 py-3 rounded-xl">
                      Sign in with Google
                    </button>
                  )}
                </motion.div>
