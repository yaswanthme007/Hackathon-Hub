...
export default function HackathonCard({ hackathon, userStatus, isLoggedIn, onStatusChange, index }: Props) {
  ...
  const rotateX = useSpring(useTransform(mouseY, [-0.5, 0.5], [3, -3]), { stiffness: 280, damping: 28 });
  const rotateY = useSpring(useTransform(mouseX, [-0.5, 0.5], [-3, 3]), { stiffness: 280, damping: 28 });
        ...
        <div className="relative h-44 overflow-hidden">
          ...
          <div className="absolute top-3 left-3 right-3 flex items-center justify-between z-10">
            <motion.span
              ...
              style={{ background: 'rgba(0,0,0,0.6)', border: '1px solid rgba(255,255,255,0.12)', color: '#a1a1aa', backdropFilter: 'blur(8px)' }}
            >
            ...
            <motion.span
              ...
              style={{ background: 'rgba(0,0,0,0.6)', border: '1px solid rgba(255,255,255,0.10)', color: '#a1a1aa', backdropFilter: 'blur(8px)' }}
            >
          ...
          {hackathon.tags?.length > 0 && (
            <div className="flex flex-wrap gap-1.5">
              {hackathon.tags.slice(0, 3).map((tag) => (
                <motion.span key={tag} className="tag" whileHover={{ scale: 1.05 }}>
                  {tag}
                </motion.span>
              ))}
