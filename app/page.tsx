      ...
      <main ref={gridRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 pb-24">
        ...
        {!session && !loading && hackathons.length > 0 && (
          <motion.div
            ...
            className="mt-20"
          >
            <div className="relative max-w-lg mx-auto text-center rounded-3xl p-10 overflow-hidden border-spin"
              style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.09)' }}>
              <div className="absolute top-0 left-1/2 -translate-x-1/2 w-48 h-20 rounded-full blur-3xl pointer-events-none"
              ...
              <motion.button
                onClick={() => signIn('google')}
                className="btn-white inline-flex items-center gap-2.5 text-black font-bold px-7 py-3 rounded-full"
                whileHover={{ scale: 1.04 }}
                whileTap={{ scale: 0.96 }}
              >
